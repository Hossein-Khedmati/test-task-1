...
const BasketIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeWidth={1.5}
    />
    <path d="M9.75977 14V17.55" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
    <path d="M14.3604 14V17.55" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
    <path
