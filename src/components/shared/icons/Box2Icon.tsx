...
const Box2Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    />
    <path
      d="M20.3904 10.13L14.3404 13.16C13.5904 13.54 13.1104 14.31 13.1104 15.15V20.87C13.1104 21.7 13.9804 22.23 14.7204 21.86L20.7704 18.83C21.5204 18.45 22.0004 17.68 22.0004 16.84V11.12C22.0004 10.29 21.1304 9.75999 20.3904 10.13Z"
      stroke="currentColor"
      strokeWidth={1.5}
      strokeLinecap="round"
      strokeLinejoin="round"
